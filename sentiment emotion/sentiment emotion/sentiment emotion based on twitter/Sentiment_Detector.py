...
root = tk.Tk()
root.title("Sentiment Analysis Of  Flipkart")
...
# player.play()
image2 =Image.open(r'C:\Users\shaik\Downloads\sentiment emotion\sentiment emotion\sentiment emotion based on twitter/img3.jpg')
...
###########################################################################################################
lbl = tk.Label(root, text="Sentiment Analysis Of  Flipkart", font=('times', 35,' bold '), height=1, width=55,bg="#FFBF40",fg="black")
lbl.place(x=0, y=0)
##############################################################################################################################
...
def Data_Display():
    ...
    data1 = pd.read_csv(r"C:\Users\shaik\Downloads\sentiment emotion\sentiment emotion\sentiment emotion based on twitter/sentiment_dataset.csv", encoding='unicode_escape')
...
def Train():
    ...
    result = pd.read_csv(r"C:\Users\shaik\Downloads\sentiment emotion\sentiment emotion\sentiment emotion based on twitter/sentiment_dataset.csv",encoding = 'unicode_escape')
 ...
 ###########################################################################################################################################
    ...
    with open('mlmodel.pickle', 'wb') as fin:
        pickle.dump(clf, fin)
